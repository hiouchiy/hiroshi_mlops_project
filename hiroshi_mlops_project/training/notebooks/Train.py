...
# ``hiroshi_mlops_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-hiroshi_mlops_project-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.hiroshi_mlops_project.hiroshi_mlops_project-model", label="Full (Three-Level) Model Name"
)
